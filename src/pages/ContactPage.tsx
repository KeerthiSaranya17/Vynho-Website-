        ...
        <div className="grid lg:grid-cols-[50%_50%] items-start gap-6">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] p-4 hover:border-primary-500/30 hover:bg-white/[0.03]
hover:-translate-y-1
          ...
          <div >
            <div className="rounded-3xl border border-white/10 bg-white/0.03 p-6 backdrop-blur-xl shadow-[0_0_30px_rgba(255,255,255,0.10)] hover:border-primary-500/30">
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full rounded-full bg-gradient-to-r from-indigo-500 to-violet-600
hover:shadow-[0_0_30px_rgba(99,102,241,0.4)] px-6 py-3 font-medium text-white transition-all duration-300 hover:scale-[1.02]"
                >
                  Send Message
                </button>
              </form>
              <div className="absolute right-0 top-1/2 -z-10 h-[500px] w-[500px] -translate-y-1/2 rounded-full bg-primary-500/10 blur-[140px]" />
            </div>
          </div>
        </div>
      </div>
